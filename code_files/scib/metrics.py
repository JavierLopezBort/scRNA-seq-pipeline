...
from .silhouette import silhouette_label, silhouette_batch, silhouette_batch_label, silhouette_label_batch
...
def metrics(
    ...
    silhouette_label_ = False,
    silhouette_batch_label_ = False,
    silhouette_label_batch_ = False,
    si_metric="euclidean",
    pcr_=False,
    cell_cycle_=False,
    organism="mouse",
    ...
    if silhouette_batch_label_:
        # silhouette coefficient per batch
        asw_batch, sil_means = silhouette_batch_label(
            adata_int,
            batch_key=batch_key,
            label_key=label_key,
            embed=embed,
    ...
    if silhouette_label_batch_:
        # silhouette coefficient per batch
        asw_label = silhouette_label_batch(
            adata_int,
            batch_key=batch_key,
            label_key=label_key,
            embed=embed,
