...
with tempfile.TemporaryDirectory() as tmpdir:
    ...
    print(os.listdir(f"{tmpdir}/solo_Gene/filtered/"))
    ...
    if snakemake.output.get("solo_out"):
        shell("cat {tmpdir}/solo_Barcodes.stats > {snakemake.output.solo_barcode_stats:q}")
        shell("cat {tmpdir}/solo_Gene/filtered/barcodes.tsv > {snakemake.output.solo_out:q}")
