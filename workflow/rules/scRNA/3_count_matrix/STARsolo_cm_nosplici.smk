...
rule STARsolo_cm_nosplici:
    input:
        matrix = expand(f"{bp}/2_alignment{bm_aln}/{{sample}}/Solo.out/Gene/filtered/matrix.mtx", sample = sns),
        features = expand(f"{bp}/2_alignment{bm_aln}/{{sample}}/Solo.out/Gene/filtered/features.tsv", sample = sns),
        barcodes = expand(f"{bp}/2_alignment{bm_aln}/{{sample}}/Solo.out/Gene/filtered/barcodes.tsv", sample = sns),
    ...
    resources:
        mem_mb=48000
    script:
        "../../../scripts/scRNA/3_count_matrix/STARsolo_cm_nosplici.py"
